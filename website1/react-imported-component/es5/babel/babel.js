...
// load configuration
var configurationFile = path_1.join(process.cwd(), '.imported.js');
var defaultConfiguration = (fs_1.existsSync(configurationFile)
    ? require(configurationFile)
    : {});
exports.createTransformer = function (_a, excludeMacro, configuration) {
        ...
        traverse: function (programPath, fileName) {
            ...
            programPath.traverse({
                ...
                Import: function (_a) {
                    ...
                    var newComments = magic_comments_1.processComment(configuration, comments, importName, fileName, {
...
exports.babelPlugin = function (babel, options) {
    if (options === void 0) { options = {}; }
    var transformer = exports.createTransformer(babel, false, tslib_1.__assign({}, defaultConfiguration, options));
    return {
        inherits: syntax,
        visitor: {
            Program: {
